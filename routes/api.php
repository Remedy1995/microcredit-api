...
use App\Http\Controllers\LongTerm;
use App\Http\Controllers\LongTermLoan;
...
Route::prefix('v1')->group(function () {
    ...
    Route::apiResource('/long-term', LongTermLoan::class)->middleware('auth:sanctum');
    ...
    Route::get('/monthly-contributions/{id}', [MonthlyContributions::class, 'showContributionById'])->middleware('auth:sanctum');
    ...
    Route::get('/loan-repayments/{id}', [LoanRepayment::class, 'showLoanRepaymentById'])->middleware('auth:sanctum');
    ...
    Route::get('/get-all-loans-repayments', [LoanRepayment::class, 'viewAllLoanRepayments'])->middleware('auth:sanctum');
    Route::get('/get-user-loans-repayments', [LoanRepayment::class, 'userViewLoanRepayments'])->middleware('auth:sanctum');
    ...
    Route::post('/approve-requested-refunds', [RefundLoans::class, 'approveRequestedReFunds'])->middleware('auth:sanctum');
    ...
    Route::put('/approve-all-early-settlement-forms-long-term-loans-application/{long_term}', [EarlySettlement::class, 'ApproveEarlyStatementFormForLongTermLoan'])->middleware('auth:sanctum');
...
Route::prefix('auth')->group(function () {
    ...
    Route::put('/user-permission/{id}', [AuthController::class, 'Permission'])->middleware('auth:sanctum');
