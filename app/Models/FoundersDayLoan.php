...
class FoundersDayLoan extends Model
{
        use HasFactory;
        protected $table = 'founders_day_loan_application';
        protected $fillable = [
            'application_id',
            'application_name',
            'principal_amount',
        ...
        {
            return $this->hasMany(ApplicationDetails::class, 'founders_day_detail_id', 'id');
        }
